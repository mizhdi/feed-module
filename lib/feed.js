...
var Feed = (function () {
  function Feed(options) {
    ...
    this.jsToXml = function () { return toXML(this.jsToXmlObj, this.jsToXmlOptions) };
    this.setJsToXmlObj = function (obj) { return this.jsToXmlObj = obj; };
    this.setJsToXmlOptions = function (options) { return this.jsToXmlOptions = options; }
  }
  return Feed;
}());
exports.Feed = Feed;
